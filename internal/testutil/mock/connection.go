...
// Source: internal/service/supervisor.go
...
import (
	...
	service "github.com/r-erema/wapi/internal/service"
	reflect "reflect"
)
...
func (m *MockConnections) AddAuthenticatedConnectionForSession(sessionID string, sessConnDTO *service.SessionConnectionDTO) error {
	m.ctrl.T.Helper()
...
func (m *MockConnections) AuthenticatedConnectionForSession(sessionID string) (*service.SessionConnectionDTO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AuthenticatedConnectionForSession", sessionID)
	ret0, _ := ret[0].(*service.SessionConnectionDTO)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
